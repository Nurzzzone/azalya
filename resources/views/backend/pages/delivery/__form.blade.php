<table class="table table-striped table-bordered datatable">
    <tbody>
        ...
        @include('backend.pages.partials.input', ['input' => 'text', 'field' => "price_title", 'current_value' => $object->price_title, 'locale' => 'fields.price_title'])
        @include('backend.pages.partials.textarea', ['field' => "price", 'current_value' => $object->price])
    </tbody>
</table>