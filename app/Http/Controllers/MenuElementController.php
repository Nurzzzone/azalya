...
class MenuElementController extends Controller
{
    ...
    public function index(Request $request){
        ...
        return view('backend.pages.editmenu.index', array(
    ...
    public function create(){
        return view('backend.pages.editmenu.create',[
            'roles'    => RolesService::get(),
            'menulist' => Menulist::all(),
        ]);
    }
    ...
    public function edit(Request $request){
        ...
        return view('backend.pages.editmenu.edit',[
            'roles'    => RolesService::get(),
            'menulist' => Menulist::all(),
    ...
    public function show(Request $request){
        ...
        return view('backend.pages.editmenu.show',[
            'menulist' => Menulist::all(),
