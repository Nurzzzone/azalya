...
class MailController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.pages.email.index', ['emailTemplates' => $emailTemplates]);
    }
    ...
    {
        return view('backend.pages.email.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.pages.email.show', [ 'template' => $template ]);
    }
    ...
    {
        $template = EmailTemplate::find($id);
        return view('backend.email.edit', [ 'template' => $template ]);
    }
    ...
    public function prepareSend($id){
        $template = EmailTemplate::find($id);
        return view('backend.email.send', [ 'template' => $template ]);
    }
