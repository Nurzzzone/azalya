...
class MenuController extends Controller
{
    ...
    public function index(Request $request){
        return view('backend.pages.editmenu.menu.index', array(
            'menulist'  => Menulist::all()
        ));
    }

    public function create(){
        return view('backend.pages.editmenu.menu.create',[]);
    }
    ...
    public function edit(Request $request){
        return view('backend.pages.editmenu.menu.edit',[
    ...
    public function show(Request $request){
        return view('backend.editmenu.menu.show',[
            'menulist'  => Menulist::where('id', '=', $request->input('id'))->first()
        ]);
    }
    */
    ...
    public function delete(Request $request){
        ...
        if(!empty($menus)){
            ...
            return view('backend.shared.universal-info');
        }else{
